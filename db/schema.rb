...
ActiveRecord::Schema.define(version: 20150923062825) do
  ...
  add_index "episodes", ["channel_id", "slug"], name: "index_episodes_on_channel_id_and_slug", unique: true, using: :btree
